...
<div class='restaurant__details'>
    <div class='restaurant__image'>
        <img class='lazyload' id='restaurant__poster' data-src='${CONFIG.BASE_IMAGE_URL + data.restaurant.pictureId}' alt='${data.restaurant.name}' />
    </div>
        ...
        <div class="restaurantContainer" id="restaurantContainer" tabindex="0">
                <div class="card" id="card">
                    <a href="/#/detail/${restaurant.id}">
                        ...
                        <img data-src="${CONFIG.BASE_IMAGE_URL + restaurant.pictureId}" class="lazyload" alt="${restaurant.name}">
